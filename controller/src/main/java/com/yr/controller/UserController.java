...
public class UserController {
    ...
    public String add(@Valid Ssmp user, BindingResult result, Map<String, Object> map, @RequestParam(value = "picture", required = false) MultipartFile files) throws Exception {
        ...
        String pathUrl = "C:\\Users\\Administrator\\Desktop\\git\\" + VerifyCodeUtil.randomCode() + System.currentTimeMillis() + files.getOriginalFilename().substring(files.getOriginalFilename().lastIndexOf("."));
    ...
    public String update(@Valid Ssmp user, BindingResult result, Map<String, Object> map, @RequestParam(value = "picture", required = false) MultipartFile files) {
        if (result.getErrorCount() > 0) {
            for (FieldError error : result.getFieldErrors()) {
                System.out.println(error.getField() + "  :  " + error.getDefaultMessage());
            }
    ...
    public String upoadFile(@RequestParam("headFile") CommonsMultipartFile[] commonsmultipartfile) throws IOException {
        for (CommonsMultipartFile cmf : commonsmultipartfile) {
            ...
            String path = "C:\\Users\\Administrator\\Desktop\\git\\";
